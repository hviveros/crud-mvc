			...
			<div class="col-md-6 offset-3">
				<form class="text-left">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="nombre" aria-describedby="nombreHelp" value="Mark" disabled>
						<small id="nombreHelp" class="form-text text-muted">Ingrese el nombre completo del cliente.</small>
					</div>
					<div class="form-group">
						<label for="email">E-mail</label>
						<input type="email" class="form-control" id="email" aria-describedby="emailHelp" value="mark@mark.py" disabled>
